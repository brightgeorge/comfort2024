#admin_dashboard_calculations_br17
...
import branch17app
from . import vacate_guest_calculations17

def total_count_active_guests():
    tvr = branch17app.models.pg1_new_beds.objects.all().filter(flag=2)
    l=[]
    for i in tvr:
        l.append(i.roon_no)
...
def total_count_vaccant_rooms():
    tvr = branch17app.models.pg1_new_beds.objects.all().exclude(flag=2).order_by('roon_no')
    l=[]
    for i in tvr:
        l.append(i.roon_no)
...
def grand_total_collection():
    jan_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,jan_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            jan_tc.append(int(i.monthly_rent))

    feb_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,feb_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            feb_tc.append(int(i.monthly_rent))

    mar_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,march_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            mar_tc.append(int(i.monthly_rent))

    apr_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,april_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            apr_tc.append(int(i.monthly_rent))

    may_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,may_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            may_tc.append(int(i.monthly_rent))

    jun_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,june_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            jun_tc.append(int(i.monthly_rent))

    jul_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,july_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            jul_tc.append(int(i.monthly_rent))

    aug_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,auguest_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            aug_tc.append(int(i.monthly_rent))

    sep_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,sept_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            sep_tc.append(int(i.monthly_rent))

    oct_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,october_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            oct_tc.append(int(i.monthly_rent))

    nov_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,nov_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
            nov_tc.append(int(i.monthly_rent))

    dec_tc=[]
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2,dec_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent !='':
...
def total_collection_advance():
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2)
    jan_advance = []
    for i in total_guest_br17:
        if i.jan_advance != '':
...
def monthly_details_due_ob_ch17(request):
    jan_tc = []
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2, jan_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent != '':
    ...
    aa=vacate_guest_calculations17.monthly_collection_details_vcated()
...
# ****grand_total_collection start here
    ...
    context={
        ...
        'vcated_guest_all_details': vacate_guest_calculations17.monthly_collection_details_vcated(),
    }

    return render(request,'branches/branch17/reports/dashboard_reports/due_amount/monthly_details.html',context)

def monthly_collection_details_ob_ch17(request):
    jan_tc = []
    total_guest_br17 = branch17app.models.pg1_new_guest.objects.all().filter(flag=2, jan_rent_flag__gt=99)
    for i in total_guest_br17:
        if i.monthly_rent != '':
    ...
    return render(request,'branches/branch17/reports/dashboard_reports/due_amount/monthly_collection_details.html',context)
