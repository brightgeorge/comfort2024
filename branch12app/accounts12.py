...
from branch12app.models import table1,in_exp_items_daily,opening_balance,category,ledger,accounts_book,background_color,share_holders
...
def profit_sharing_choose_months12(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request,'branches/branch12/accounts/profit_sharing/profit_sharing_choose_months.html',context)

def profit_sharing12(request,mo):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch12/accounts/profit_sharing/profit_sharing.html',context)
    return render(request, 'index.html')

def view_share_holders12(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch12/accounts/profit_sharing/view_share_holders.html',context)

def create_share_holders12(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch12/accounts/profit_sharing/create_share_holders.html',context)


def regi_share_holders12(request):
    if 'username' in request.session:
...
def update_share_holders12(request,id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch12/accounts/profit_sharing/update_share_holders.html',context)

def delete_share_holders12(request,id):
    if 'username' in request.session:
...
def view_deleted_share_holders12(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch12/accounts/profit_sharing/view_deleted_share_holders.html',context)
