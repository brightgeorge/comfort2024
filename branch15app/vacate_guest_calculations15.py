...
def total_count_active_guests():
    tvr = branch15app.models.pg1_new_beds.objects.all().filter(flag=3)
    l=[]
    for i in tvr:
        l.append(i.roon_no)
...
def total_count_vaccant_rooms():
    tvr = branch15app.models.pg1_new_beds.objects.all().exclude(flag=3).order_by('roon_no')
    l=[]
    for i in tvr:
        l.append(i.roon_no)
...
def grand_total_collection():
    jan_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,jan_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 1 == i.guest_vacate_month:
            jan_tc.append(int(i.monthly_rent))

    feb_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,feb_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 2 == i.guest_vacate_month:
            feb_tc.append(int(i.monthly_rent))

    mar_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,march_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 3 == i.guest_vacate_month:
            mar_tc.append(int(i.monthly_rent))

    apr_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,april_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 4 == i.guest_vacate_month:
            apr_tc.append(int(i.monthly_rent))

    may_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,may_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 5 == i.guest_vacate_month:
            may_tc.append(int(i.monthly_rent))

    jun_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,june_rent_flag__gt=99)
    for i in total_guest_br5 :
        if i.monthly_rent !='' and 6 == i.guest_vacate_month:
            jun_tc.append(int(i.monthly_rent))

    jul_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,july_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 7 == i.guest_vacate_month:
            jul_tc.append(int(i.monthly_rent))

    aug_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,auguest_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 8 == i.guest_vacate_month:
            aug_tc.append(int(i.monthly_rent))

    sep_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,sept_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 9 == i.guest_vacate_month:
            sep_tc.append(int(i.monthly_rent))

    oct_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,october_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 10 == i.guest_vacate_month:
            oct_tc.append(int(i.monthly_rent))

    nov_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,nov_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent !='' and 11 == i.guest_vacate_month:
            nov_tc.append(int(i.monthly_rent))

    dec_tc=[]
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3,dec_rent_flag__gt=99)
    for i in total_guest_br5:
...
def total_collection_advance():
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3)
    jan_advance = []
    for i in total_guest_br5:
...
def monthly_details_due_ob_ch1510(request):
    jan_tc = []
    total_guest_br5 = branch15app.models.pg1_new_guest.objects.all().filter(flag=3, jan_rent_flag__gt=99)
    for i in total_guest_br5:
        if i.monthly_rent != '' and 1 == i.guest_vacate_month:
