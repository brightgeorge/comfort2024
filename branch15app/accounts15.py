...
from branch15app.models import table1,in_exp_items_daily,opening_balance,category,ledger,accounts_book,background_color,share_holders
...
def view_all_category15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/category/view_all_category.html',context)
    return render(request, 'index.html')

def create_new_category15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/category/create_new_category.html',context)
    return render(request, 'index.html')

def regi_new_category15(request):
    if 'username' in request.session:
        ...
        if ir == True:
            ...
            return render(request, 'branches/branch15/accounts/creater_master/items/view_all_items.html', context)
        else:
...
def update_category15(request,id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/category/update_category.html',context)
    return render(request, 'index.html')


def delete_category15(request,id):
    if 'username' in request.session:
...
def view_all_category_delete15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/category/view_all_category_delete.html',context)
    return render(request, 'index.html')
...
def create_new_item15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/items/create_new_item.html',context)
    return render(request, 'index.html')

def regi_new_item15(request):
    if 'username' in request.session:
...
def update_item15(request,id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/items/update_item.html',context)
    return render(request, 'index.html')

def view_all_items_delete15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/items/view_all_items_delete.html',context)
    return render(request, 'index.html')
...
def view_all_ledger15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/ledger/view_all_ledger.html',context)
    return render(request, 'index.html')

def create_new_ledger15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/ledger/create_new_ledger.html',context)
    return render(request, 'index.html')

def regi_new_ledger15(request):
    if 'username' in request.session:
...
def delete_ledger15(request,id):
    if 'username' in request.session:
...
def update_ledger15(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            ledger_name = request.POST.get('ledger_name')
            contact_person_name = request.POST.get('contact_person_name')
        ...
        return render(request,'branches/branch15/accounts/creater_master/ledger/update_ledger.html',context)
    return render(request, 'index.html')

def view_all_ledger_delete15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/ledger/view_all_ledger_delete.html',context)
    return render(request, 'index.html')
...
def view_all_accounts_book15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/accounts_book/view_all_accounts_book.html',context)
    return render(request, 'index.html')

def create_new_accounts_book15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/accounts_book/create_new_accounts_book.html',context)
    return render(request, 'index.html')

def regi_new_accounts_book15(request):
    if 'username' in request.session:
...
def delete_accounts_book15(request,id):
    if 'username' in request.session:
...
def update_accounts_book15(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            accounts_book_name = request.POST.get('accounts_book_name')
        ...
        return render(request,'branches/branch15/accounts/creater_master/accounts_book/update_accounts_book.html',context)
    return render(request, 'index.html')

def view_all_accounts_book_delete15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/creater_master/accounts_book/view_all_accounts_book_delete.html',context)
    return render(request, 'index.html')
...
def in_exp_items_entry15(request):
    if 'username' in request.session:
        ...
        context = {
            ...
            'items': in_exp_items_daily.objects.all().filter(flag=1).order_by('-id')[:15],
            'ledger' : ledger.objects.all().filter(flag=1),
            'accounts_book': accounts_book.objects.all().filter(flag=1),
        }
        print(context)
        return render(request,'branches/branch15/accounts/journal/in_exp_items_entry.html',context)
    return render(request, 'index.html')



def reg_in_exp_items_entry15(request):
    if 'username' in request.session:
...
def delete_journal15(request,id):
    if 'username' in request.session:
...
def update_in_exp_items_entry15(request,id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch15/accounts/journal/update_in_exp_items_entry.html', context)
    return render(request, 'index.html')

def detailed_journal_report15(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch15/accounts/journal/detailed_journal_report.html', context)
    return render(request, 'index.html')

def journal_report_deleted15(request):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch15/accounts/journal/journal_report_deleted.html', context)
    return render(request, 'index.html')
...
def daily_category_wise15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/category/daily_category_wise.html',context)
    return render(request, 'index.html')


def monthly_category_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/category/monthly_category_based_reports.html',context)
    return render(request, 'index.html')


def yearly_category_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/category/yearly_category_based_reports.html',context)
    return render(request, 'index.html')
...
def daily_detailed15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/detailed/daily_detailed.html',context)
    return render(request, 'index.html')


def monthly_detailed15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/detailed/monthly_detailed.html',context)
    return render(request, 'index.html')


def yearly_detailed15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/detailed/yearly_detailed.html',context)
    return render(request, 'index.html')
...
def item_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/item/item_based_reports.html',context)
    return render(request, 'index.html')



def daily_item_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/item/daily_item_based_reports.html',context)
    return render(request, 'index.html')



def monthly_item_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/item/monthly_item_based_reports.html',context)
    return render(request, 'index.html')
...
def daily_ledger_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/ledger/daily_ledger_based_reports.html',context)
    return render(request, 'index.html')


def ledger_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/ledger/ledger_based_reports.html',context)
    return render(request, 'index.html')



def monthly_ledger_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/ledger/monthly_ledger_based_reports.html',context)
    return render(request, 'index.html')
...
def accounts_book_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/accounts_book/accounts_book_name_based_reports.html',context)
    return render(request, 'index.html')



def daily_accounts_book_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/accounts_book/daily_accounts_book_based_reports.html',context)
    return render(request, 'index.html')



def monthly_accounts_book_based_reports15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/accounts_reports/accounts_book/monthly_accounts_book_based_reports.html',context)
    return render(request, 'index.html')
...
def monthly_reports_choose_months15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/monthly_reports/monthly_reports_choose_months.html',context)
    return render(request, 'index.html')


def monthly_detailed_daily_in_exp_items_report15(request,mo):
    if 'username' in request.session:
    ...
    ###***************************************
        ...
        r_balance_15 = r_balance_9 + r_income_15 - r_expense_15
        ...
        r_balance_11 = r_balance_15 + r_income_11 - r_expense_11
    ...
    ##****************************************
        ...
        return render(request,'branches/branch15/accounts/monthly_reports/monthly_detailed_daily_in_exp_items_report.html',context)
    return render(request, 'index.html')
...
def single_monthly_reports_choose_months15(request):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/monthly_reports/single_monthly_reports_choose_months.html',context)
    return render(request, 'index.html')

def single_monthly_daily_in_exp_items_report15(request,mo):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch15/accounts/monthly_reports/single_monthly_daily_in_exp_items_report.html',context)
    return render(request, 'index.html')
...
def accounts_dash_board_ob_ch15(request):
    if 'username' in request.session:
        ...
        income_15 = in_exp_items_daily.objects.filter(month='15', type='income', flag=1)
        l_income_15 = []
        for i in income_15:
            l_income_15.append(float(i.amount))
        r_income_15 = sum(l_income_15)
        expense_15 = in_exp_items_daily.objects.filter(month='15', type='expense', flag=1)
        l_expense_15 = []
        for i in expense_15:
            l_expense_15.append(float(i.amount))
        r_expense_15 = sum(l_expense_15)
        r_balance_15 = r_income_15 - r_expense_15
        ...
        return render(request,'branches/branch15/accounts/accounts_dash_board.html',context)
    return render(request, 'index.html')
...
def profit_sharing_choose_months15(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request,'branches/branch15/accounts/profit_sharing/profit_sharing_choose_months.html',context)

def profit_sharing15(request,mo):
    if 'username' in request.session:
        ...
        print('amt',amt)
        for i in sh:
            ta = amt / 150 * float(i.share_holders_percentage)
            print('taa',ta)
        ...
        return render(request,'branches/branch15/accounts/profit_sharing/profit_sharing.html',context)
    return render(request, 'index.html')

def view_share_holders15(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch15/accounts/profit_sharing/view_share_holders.html',context)

def create_share_holders15(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch15/accounts/profit_sharing/create_share_holders.html',context)


def regi_share_holders15(request):
    if 'username' in request.session:
        ...
        if tsa <151:
            ...
            return view_share_holders15(request)
        me= 'SHARE HOLDER DOES NOT CREATED, BECAUSE SHARE % OUT OF 150!. NOW TOTAL % IS ' + str(tsa)
        messages.info(request,me)
        return view_share_holders15(request)

def update_share_holders15(request,id):
    if 'username' in request.session:
        if request.method == 'POST':
            name = request.POST.get('name')
            share = request.POST.get('share')
        ...
        return render(request, 'branches/branch15/accounts/profit_sharing/update_share_holders.html',context)

def delete_share_holders15(request,id):
    if 'username' in request.session:
...
def view_deleted_share_holders15(request):
    if 'username' in request.session:
        us = request.session['username']
        bgs = background_color.objects.all().filter(username=us)
        bg = background_color.objects.all().filter(username=us).exists()
        ...
        return render(request, 'branches/branch15/accounts/profit_sharing/view_deleted_share_holders.html',context)
