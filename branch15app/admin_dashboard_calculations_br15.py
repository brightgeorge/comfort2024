...
def monthly_details_due_ob_ch15(request):
    ...
    aa=vacate_guest_calculations10.monthly_collection_details_vcated()
...
# ****grand_total_collection start here
    ...
    context={
        ...
        'vcated_guest_all_details': vacate_guest_calculations10.monthly_collection_details_vcated(),
    }
