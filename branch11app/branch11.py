...
def user_dashboard_calculations_ob_ch11(request):
    if 'username' in request.session:
        us = request.session['username']
        a = admin_dashboard_calculations_br11.grand_total_collection()
        from datetime import datetime
    ...
    return render(request, 'branches/branch11/user_dashboard_calculations.html', context)
    return render(request, 'index.html')
...
def new_year_jan_print_ob_ch11(request):
    if 'username' in request.session:
        ag = pg1_new_beds.objects.all().order_by('roon_no')
        l = []
        t = []
        ...
        return render(request, 'branches/branch11/print_outs/new_year_jan_print.html', context)
    return render(request, 'index.html')
