...
def monthly_jan_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/jan/monthly_jan_make_payments.html',context)
...
def monthly_feb_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/feb/monthly_feb_make_payments.html',context)
...
def monthly_march_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/march/monthly_march_make_payments.html',context)
...
def monthly_april_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/april/monthly_april_make_payments.html',context)
...
def monthly_may_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch8/payments/payment_details_of_months/may/monthly_may_make_payments.html',context)
...
def monthly_june_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/june/monthly_june_make_payments.html',context)
...
def monthly_july_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/july/monthly_july_make_payments.html',context)
...
def monthly_aug_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch8/payments/payment_details_of_months/aug/monthly_aug_make_payments.html',context)
...
def monthly_sept_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request,'branches/branch8/payments/payment_details_of_months/sept/monthly_sept_make_payments.html',context)
...
def monthly_oct_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch8/payments/payment_details_of_months/oct/monthly_oct_make_payments.html',context)
...
def monthly_nov_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch8/payments/payment_details_of_months/nov/monthly_nov_make_payments.html',context)
...
def monthly_dec_make_payments8(request, id):
    if 'username' in request.session:
        ...
        return render(request, 'branches/branch8/payments/payment_details_of_months/dec/monthly_dec_make_payments.html',context)
